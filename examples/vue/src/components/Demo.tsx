    ...
    return (
      <Document>
        <Page style={styles.body}>
          ...
          <Text style={styles.text}>
            Con estas y semejantes razones perdía el pobre caballero el juicio,
            y desvelábase por entenderlas, y desentrañarles el sentido, que no
          ...
          <Text style={styles.text}>
            ...
            y abusos que mejorar y deudas que satisfacer. Y así, sin dar parte a
            persona alguna de su intención y sin que nadie le viese, una mañana,
            antes del día, que era uno de los calurosos del mes de Julio, se
            armó de todas sus armas, subió sobre Rocinante, puesta su mal
            ...
            Mas apenas se vio en el campo cuando le asaltó un pensamiento
            ...
            conforme a ley de caballería, ni podía ni debía tomar armas con
            ningún caballero; y puesto que lo fuera, había de llevar armas
            ...
            en su propósito; mas pudiendo más su locura que otra razón alguna,
            propuso de hacerse armar caballero del primero que topase, a
            imitación de otros muchos que así lo hicieron, según él había leído
            en los libros que tal le tenían. En lo de las armas blancas, pensaba
            limpiarlas de manera, en teniendo lugar, que lo fuesen más que un
            arminio; y con esto se quietó18 y prosiguió su camino, sin llevar
          ...
          <Text style={styles.text}>
            ...
            pequeños y pintados pajarillos con sus arpadas lenguas habían
            saludado con dulce y meliflua armonía la venida de la rosada Aurora,
          ...
          <Text style={styles.text}>
            ...
            mías, dignas de entallarse en bronces, esculpirse en mármoles y
            pintarse en tablas, para memoria en lo futuro. ¡Oh tú, sabio
            encantador, quienquiera que seas, a quien ha de tocar el ser
            coronista desta peregrina historia! Ruégote que no te olvides de mi
          ...
          <Text style={styles.text}>
            ...
            enseñado, imitando en cuanto podía su lenguaje. Con esto caminaba
          ...
          <Text style={styles.text}>
            ...
            Lápice, otros dicen que la de los molinos de viento; pero lo que yo
            ...
            anochecer, su rocín y él se hallaron cansados y muertos de hambre, y
